import media
# media is used to build class movie
import fresh_tomatoes
# fresh tomatoes is used to build the html page

# Joseph Langdale FSND 8-20-2017
# this code is used in conjuction with media.py and fresh_tomatoes.py to build a HTML page
...
dunkirk = media.Movie("Dunkirk",
                    "The strugle of the British Army to return home from France early in World War 2.",
                    "Christopher Nolan",
                    "2017",
...
spider_man_homecoming = media.Movie( "Spider-Man:Homecoming",
                                   "Peter Parker returns to New YOrk after his Avenger outing.",
                                   "Jon Watts",
                                   "2017",
...
wonder_woman = media.Movie("Wonder Woman                ",
                           "In a time of war a hero leaves her home to save the world.",
                           "Patty Jenkins",
                           "2017",
...
colossal = media.Movie("Colossal",
                       "An unemployed writer returns to her hometown to sort things out",
                       "Nacho Vigalondo",
                       "2017",
                       "https://upload.wikimedia.org/wikipedia/en/3/33/Colossal_%28film%29.png",
                       "https://www.youtube.com/watch?v=Q8hpm_BcHKE"
                       )

kong = media.Movie ("Kong:Skull Island",
                    "Researchers are escorted to a seculded island in the Pacific",
                    "Jordan Vogt-Roberts",
                    "2017",
